                      ...
                      >
                        {(provided) => (
                          <div
                            ...
                            ref={provided.innerRef}
                          >
                            <div className="bg-primary/10  rounded-md flex justify-between items-center p-2 mb-1 border border-gray-400 text-black">
                              <div className="w-full flex flex-wrap items-center gap-x-3 pr-5 text-black">
                                {React.Children.toArray(
                                  print.map((it) => {
