...
export default function Radio({ label, options, ...props }) {
  ...
  return (
    <div className="flex flex-col w-full p-2">
      <div className="text-base text-black mb-1 flex items-center">{label}</div>
          ...
          >
            <span
              className={classNames({
                ...
                "bg-gray-300 before:bg-transparent group-hover:before:bg-gray-200":
                  fields.value !== option.key,
                "bg-gray-300 before:bg-white": fields.value === option.key,
              })}
            />
