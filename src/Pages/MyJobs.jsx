...
const MyJobs = () => {
    ...
    useEffect(() => {
        setIsLoading(true)
        fetch('http://localhost:3000/').then(res => res.json()).then(date => {
            setJobs(date);
            setIsLoading(false);
        });
    }, [searchText]);
    ...
    return <div className="  max-w-screen-2xl container mx-auto xl:px-24 px-4">
        <div className='my-jobs-container'>
            ...
            <div className='search-box p-2 text-center mb-2'>
                <input pnchange={(e) => setSearchText(e.target.value)} type="text" name='search' id='search' className=' py-2 pl-3 border focus:outline-none lg:w-6/12 mb-4 w-full' />
